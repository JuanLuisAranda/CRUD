...
<html>
    <head>
        ...
        <style>
            body {background-image: url("imgs/fondo-perro.jpg")}
        </style>
    </head>
    <body>
        <p class="right">
    ...
    <h1 class="text-center">Perrera</h1>
        ...
        <table class="table bg-light text-center">
            ...
            <div style="margin: 7vw">
                <h1 style="width: 50vw">Debes <a href="inicio.jsp">iniciar sesión</a> para acceder al listado de perros registrados.</h1>
            </div>     
